...
class MainWindow(QMainWindow):  # Main window class inherited from QMainWindow
    def __init__(self):  # Constructor
        super().__init__()
        self.ui_menu = Ui_menu.Ui_MainWindow()  #facilita la conexion con Ui_menu
        self.ui_config = Ui_configuracion.Ui_MainWindow()  #facilita la conexion con Ui_configuracion
        self.ui_estadistic = Ui_estadisticas_1.Ui_MainWindow() #facilita la conexion con Ui_estadisticas_1
        self.ui_estadistic_2 = Ui_estadisticas_2.Ui_MainWindow() #facilita la conexion con Ui_estadisticas_2
